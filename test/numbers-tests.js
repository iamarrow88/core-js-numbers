...
describe('core-js-numbers-tasks optimal implementation', () => {
  ...
  it.optional('optimal implementation of isNumber', function test() {
    ...
    assert.equal(
      ...
      true,
      'You need to use a different method or operator, look for the appropriate method or operator in the documentation https://developer.mozilla.org/en-US/docs/Web/JavaScrit/Reference/Global_Objects/Number'
    );
  });
